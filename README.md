...
1. **Clone o repositório**
   ```bash
   git clone https://github.com/herick-ferreira/Streamlit-app-checklists.git
   cd Streamlit-app-checklists
   ```
...
**Desenvolvido com ❤️ por [herick-ferreira](https://github.com/herick-ferreira)**
